...
export default {
  ...
  mounted() {
    ...
    this.nodes = range(particleAmount).map((k, i) => {
      ...
      const spr = new pixi.Sprite.from("/static/test.png");
      ...
      spr.tint = parseInt(rgb(r, g, b).hex().substr(1), 16);
    ...
    this.simulation = forceSimulation(this.nodes)
      ...
      .force("link", forceLink(this.links).distance(this.zoom).strength(0.7))
      .force(
        "radial",
